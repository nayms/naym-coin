...
module.exports = {
  ...
  targets: {
    ...
    mainnet: { network: "mainnet", wallet: "deployerWallet", initArgs: [mainnetSysAdminAddress], create3Salt: process.env.NAYM_SALT },
    ...
    base: { network: "base", wallet: "deployerWallet", initArgs: [mainnetSysAdminAddress], create3Salt: process.env.NAYM_SALT },
    baseFork: { network: "local", wallet: "devOwnerWallet", governance: "devSysAdminWallet", initArgs: [mainnetSysAdminAddress] },
    aurora: { network: "aurora", wallet: "deployerWallet", initArgs: [mainnetSysAdminAddress], create3Salt: process.env.NAYM_SALT },
